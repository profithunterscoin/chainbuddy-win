...
'####################################################################
'###     Chain Buddy 1.1 (Win32) - Profit Hunters Coin © 2018     ###
'###      Automatically monitor node/peer blockchain health       ###
'###      Official Website: www.ProfitHuntersCoin.com             ###
'### Official Github: github.com/profithunterscoin/chainbuddy-win ###
'####################################################################
...
Sub CheckForForks()
    ...
    For i = 1 To Chains.Rows - 1
        ...
        If IsNumeric(Chains.TextMatrix(i, 1)) = True Then
...
Main.Caption = "Chain Buddy " & App.Major & "." & App.Minor & "." & App.Revision & " (Win32) - Profit Hunters Coin © 2018"
